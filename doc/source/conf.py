...
# built documents.
version_py = os.path.join(root_dir, 'meld', 'version.py')
...
latex_documents = [
    (master_doc, 'meld.tex', 'meld Documentation',
     'Daniel Burkhardt', 'manual'),
]
...
man_pages = [
    (master_doc, 'meld', 'meld Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'meld', 'meld Documentation',
     author, 'meld', 'One line description of project.',
     'Miscellaneous'),
]
